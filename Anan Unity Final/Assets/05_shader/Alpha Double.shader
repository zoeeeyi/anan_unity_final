    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( fixed, _SoftParticle)
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _FresnelOpPower)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _FresnelOp)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _Dissolve)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _PanUV)
                UNITY_DEFINE_INSTANCED_PROP( float, _BackFacePower)
                UNITY_DEFINE_INSTANCED_PROP( float, _NIUQU)
                UNITY_DEFINE_INSTANCED_PROP( float, _Rotator)
                UNITY_DEFINE_INSTANCED_PROP( float, _DissPower)
                UNITY_DEFINE_INSTANCED_PROP( float, _Smoot)
                UNITY_DEFINE_INSTANCED_PROP( float, _SoftPower)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _DissOrPower)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _NiuQUDiss)
                UNITY_DEFINE_INSTANCED_PROP( float4, _VertexPower)
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _OpacityU_Speed)
                UNITY_DEFINE_INSTANCED_PROP( float, _OpacityV_Speed)
                UNITY_DEFINE_INSTANCED_PROP( float, _N_U_Speed)
                UNITY_DEFINE_INSTANCED_PROP( float, _N_V_Speed)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _1Fresnel)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _NIuqU_UV)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _TileOff)
                UNITY_DEFINE_INSTANCED_PROP( float, _DissUSpeed)
                UNITY_DEFINE_INSTANCED_PROP( float, _DissVSpeed)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _VEMask)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _FaceFilp)
                UNITY_DEFINE_INSTANCED_PROP( fixed, _NiuOpacity)
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_6227 = float2(((_VPan_U_var*node_6902.g)+o.uv0.r),(o.uv0.g+(node_6902.g*_VPan_V_var)));
                float4 _VertexT_var = tex2Dlod(_VertexT,float4(TRANSFORM_TEX(node_6227, _VertexT),0.0,0));
                float4 _VertexPower_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VertexPower );
                float4 _VetexMax_var = tex2Dlod(_VetexMax,float4(TRANSFORM_TEX(o.uv0, _VetexMax),0.0,0));
                float3 _VEMask_var = lerp( 1.0, _VetexMax_var.rgb, UNITY_ACCESS_INSTANCED_PROP( Props, _VEMask ) );
                float3 _VerTexOffest_var = lerp( 0.0, (_VertexT_var.rgb*_VertexPower_var.rgb*v.normal*o.uv1.g*_VEMask_var), UNITY_ACCESS_INSTANCED_PROP( Props, _VerTexOffest ) );
                v.vertex.xyz += _VerTexOffest_var;
...
////// Emissive:
                ...
                float _Rotator_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Rotator );
                float node_3814_ang = ((_Rotator_var*3.141592654)/180.0);
                ...
                float2 _TileOff_var = lerp( node_358, saturate(node_358), UNITY_ACCESS_INSTANCED_PROP( Props, _TileOff ) );
                float2 _PanUV_var = lerp( float2(((_USpeed_var*node_3610.g)+i.uv0.r),(i.uv0.g+(node_3610.g*_VSpeed_var))), _TileOff_var, UNITY_ACCESS_INSTANCED_PROP( Props, _PanUV ) );
                float _N_U_Speed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _N_U_Speed );
                float4 node_7090 = _Time;
                float _N_V_Speed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _N_V_Speed );
                float2 node_9535 = (float2(((_N_U_Speed_var*node_7090.g)+i.uv0.r),(i.uv0.g+(node_7090.g*_N_V_Speed_var)))*2.0+-1.0);
                float4 __var = tex2D(_,TRANSFORM_TEX(node_9535, _));
                float _NIUQU_var = UNITY_ACCESS_INSTANCED_PROP( Props, _NIUQU );
                float _NIuqU_UV_var = lerp( _NIUQU_var, i.uv1.g, UNITY_ACCESS_INSTANCED_PROP( Props, _NIuqU_UV ) );
                float node_2201 = (__var.r*_NIuqU_UV_var);
                float2 node_3814 = (mul((_PanUV_var+node_2201)-node_3814_piv,float2x2( node_3814_cos, -node_3814_sin, node_3814_sin, node_3814_cos))+node_3814_piv);
                float4 _Textures_var = tex2D(_Textures,TRANSFORM_TEX(node_3814, _Textures));
                float3 node_8018 = (_Color_var.rgb*_Textures_var.rgb*i.vertexColor.rgb);
                float _BackFacePower_var = UNITY_ACCESS_INSTANCED_PROP( Props, _BackFacePower );
                float _FaceFilp_var = lerp( isFrontFace, (1.0 - isFrontFace), UNITY_ACCESS_INSTANCED_PROP( Props, _FaceFilp ) );
                float3 emissive = (_GampColor_var.rgb*lerp((node_8018*_BackFacePower_var),node_8018,_FaceFilp_var));
                float3 finalColor = emissive;
                float _TextureAlpha_var = lerp( _Textures_var.r, _Textures_var.a, UNITY_ACCESS_INSTANCED_PROP( Props, _TextureAlpha ) );
                float _OpacityU_Speed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _OpacityU_Speed );
                float4 node_2775 = _Time;
                float _OpacityV_Speed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _OpacityV_Speed );
                float2 node_3064 = float2(((_OpacityU_Speed_var*node_2775.g)+i.uv0.r),(i.uv0.g+(node_2775.g*_OpacityV_Speed_var)));
                float2 _NiuOpacity_var = lerp( node_3064, (node_2201+node_3064), UNITY_ACCESS_INSTANCED_PROP( Props, _NiuOpacity ) );
                float4 _OpacityTextures_var = tex2D(_OpacityTextures,TRANSFORM_TEX(_NiuOpacity_var, _OpacityTextures));
                float _MaskTex_var = lerp( _TextureAlpha_var, (_TextureAlpha_var*_OpacityTextures_var.r), UNITY_ACCESS_INSTANCED_PROP( Props, _MaskTex ) );
                float _SoftPower_var = UNITY_ACCESS_INSTANCED_PROP( Props, _SoftPower );
                float _SoftParticle_var = lerp( 1.0, saturate((sceneZ-partZ)/_SoftPower_var), UNITY_ACCESS_INSTANCED_PROP( Props, _SoftParticle ) );
                float _FresnelOpPower_var = UNITY_ACCESS_INSTANCED_PROP( Props, _FresnelOpPower );
                float node_6208 = (1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelOpPower_var));
                float _1Fresnel_var = lerp( node_6208, (1.0 - node_6208), UNITY_ACCESS_INSTANCED_PROP( Props, _1Fresnel ) );
                float _FresnelOp_var = lerp( 1.0, _1Fresnel_var, UNITY_ACCESS_INSTANCED_PROP( Props, _FresnelOp ) );
                float _DissPower_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DissPower );
                float _DissOrPower_var = lerp( (1.0 - i.uv1.r), _DissPower_var, UNITY_ACCESS_INSTANCED_PROP( Props, _DissOrPower ) );
                float _Smoot_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Smoot );
                float _DissUSpeed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DissUSpeed );
                float4 node_7646 = _Time;
                float _DissVSpeed_var = UNITY_ACCESS_INSTANCED_PROP( Props, _DissVSpeed );
                float2 node_4694 = float2(((_DissUSpeed_var*node_7646.g)+i.uv0.r),(i.uv0.g+(node_7646.g*_DissVSpeed_var)));
                float2 _NiuQUDiss_var = lerp( node_4694, (node_2201+node_4694), UNITY_ACCESS_INSTANCED_PROP( Props, _NiuQUDiss ) );
                float4 _Disslov_var = tex2D(_Disslov,TRANSFORM_TEX(_NiuQUDiss_var, _Disslov));
                float _Dissolve_var = lerp( 1.0, smoothstep( _DissOrPower_var, (_DissOrPower_var+_Smoot_var), _Disslov_var.r ), UNITY_ACCESS_INSTANCED_PROP( Props, _Dissolve ) );
                float4 _MaskTextures_var = tex2D(_MaskTextures,TRANSFORM_TEX(i.uv0, _MaskTextures));
                fixed4 finalRGBA = fixed4(finalColor,(_Color_var.a*(_MaskTex_var*i.vertexColor.a*_SoftParticle_var*_FresnelOp_var*_Dissolve_var)*_MaskTextures_var.r));
